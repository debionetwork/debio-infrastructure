...
echo "Uninstalling ${REPOSITORY_NAME}-secrets-store-provider"
...
spec:
  ...
  parameters:
    secrets: |
      ...
      - resourceName: projects/${GCP_PROJECT_ID}/secrets/WEB_ANALYST_ROLE/versions/latest
        path: WEB_ANALYST_ROLE
      - resourceName: projects/${GCP_PROJECT_ID}/secrets/WEB_ANALYST_SENTRY_DSN/versions/latest
        path: WEB_ANALYST_SENTRY_DSN
      - resourceName: projects/${GCP_PROJECT_ID}/secrets/WEB_ANALYST_MIXPANEL_TOKEN/versions/latest
        path: WEB_ANALYST_MIXPANEL_TOKEN
    ...
    - secretName: ${REPOSITORY_NAME}-secrets-store
      ...
      data: 
        ...
        - key: VUE_APP_MIXPANEL_TOKEN
          objectName: WEB_ANALYST_MIXPANEL_TOKEN
        - key: VUE_APP_SENTRY_DSN
          objectName: WEB_ANALYST_SENTRY_DSN
